...
class MengajarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/mengajar/index')->with('success', "Data Mengajar telah berhasil di simpan");
    }
    ...
    public function update(Request $request, Mengajar $mengajar)
    {
        ...
        return redirect('/mengajar/index')->with('success', "data Mengajar telah di update");
    }
